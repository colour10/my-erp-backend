...
(
  ...
  sys_delete_stuff varchar(36),
  sys_delete_date  datetime,
  sys_delete_flag  tinyint     not null comment '0-未删除 1-已删除',
  sys_remote       tinyint     not null comment '0-未更新过 1-已更新过',
...
(
  ...
  sys_remote       tinyint     not null comment '0-未更新过 1-已更新过',
  ProductID        varchar(36),
  IfID             varchar(36) comment '0-添加 1-修改',
  NumOrder         int,
  ImgName          national char(1),
  Imgsize          varchar(50),
...
(
  ...
  sys_remote            tinyint     not null comment '0-未更新过 1-已更新过',
  ProductID             varchar(36),
  WashinginstructionsID varchar(36),
  primary key (id)
);
...
(
  ...
  sys_delete_flag          tinyint     not null comment '0-未删除 1-已删除',
  sys_remote               tinyint     not null comment '0-未更新过 1-已更新过',
  WarehousingFeeID         varchar(36),
  PzhID                    varchar(36),
  WarehousingFeeCurrencyID varchar(36),
...
(
  ...
  sys_delete_flag  tinyint     not null comment '0-未删除 1-已删除',
  sys_remote       tinyint     not null comment '0-未更新过 1-已更新过',
  sellspotID       varchar(36) not null,
  brandID          varchar(36) not null,
...
alter table sys_config comment '系统参数值
备注 Code-文件服务器地址,fileip
Value - 文件名';
...
(
  ...
  Remark           varchar(1000),
  Selfcompanyid    varchar(36),
  Priceid          varchar(36) comment '此价格id可以是基础价格id，也可以是销售端口id',
  Spotid           varchar(36),
  up_dp_id         varchar(36),
...
(
  ...
  Staff              varchar(36),
  DepartmemtID       varchar(36),
  DepartmemtID2      varchar(36),
...
(
  ...
  MemberLevelID    varchar(36),
  MemberType       varchar(1) comment '0-个人会员 1-公司会员',
  MemberCardID     varchar(36),
...
(
  ...
  Member_id          varchar(36),
  Brand_id           varchar(36),
  BrandGroup_id      varchar(36),
  ChildBrandGroup_id varchar(36),
  SizeTop_id         varchar(36),
  primary key (id)
);
...
(
  ...
  sys_delete_flag     tinyint     not null comment '0-未删除 1-已删除',
  sys_remote          tinyint     not null comment '0-未更新过 1-已更新过',
  MemberPreference_id varchar(36),
  SizeContent_id      varchar(36),
  SizeTop_id          varchar(36),
  primary key (id)
);
...
(
  ...
  sys_delete_flag  tinyint     not null comment '0-未删除 1-已删除',
  sys_remote       tinyint     not null comment '0-未更新过 1-已更新过',
  ProductStock_id  varchar(36),
  StockID          varchar(36),
  ToStockID        varchar(36),
  OpID             varchar(36),
  primary key (id)
);
...
(
  ...
  WordPriceCurrencyID  varchar(36),
  ...
  Groupid              varchar(36) comment '同款不同色',
...
(
  ...
  sys_remote       tinyint       not null comment '0-未更新过 1-已更新过',
  DetailID         varchar(36),
  Warehousing_id   varchar(36)   not null,
...
(
  id               varchar(36)      not null,
  code             national char(1) not null,
  chinese_name     national char(1) not null,
  english_name     national char(1),
  km_type_id       varchar(36)      not null,
  up_km_id         varchar(36),
  is_havexj        varchar(1)       not null comment '0-没有,1-有',
  jord             varchar(1)       not null comment 'J-借方,D-贷方',
  selfcompanyid    varchar(36)      not null,
  sys_create_stuff varchar(36)      not null,
  sys_create_date  datetime         not null,
  sys_modify_stuff varchar(36)      not null,
  sys_modify_date  datetime         not null,
...
(
  ...
  chinese_memo     national char(1) not null,
  english_memo     national char(1) not null,
  sys_create_stuff varchar(36)      not null,
  sys_create_date  datetime         not null,
  sys_modify_stuff varchar(36)      not null,
  sys_modify_date  datetime         not null,
...
alter table zl_unitgroup comment '???';
