...
CREATE TABLE `tb_product` (
                            ...
                            `wordprice` decimal(16,9) DEFAULT NULL,
                            `wordpricecurrencyid` int(10) UNSIGNED DEFAULT NULL,
                            `gender` varchar(10) DEFAULT NULL COMMENT '0-女式 1-男士 2-中性',
                            `brand` int(10) UNSIGNED DEFAULT NULL,
                            `brandtype` int(10) UNSIGNED DEFAULT NULL,
                            `childbrand` int(10) UNSIGNED DEFAULT NULL,
                            `brandcolor` int(10) UNSIGNED DEFAULT NULL,
                            ...
                            `occasion` int(10) UNSIGNED DEFAULT NULL,
                            ...
                            `laststoragedate` datetime DEFAULT NULL,
                            `aliases_1` varchar(50) DEFAULT NULL,
                            `aliases_2` varchar(50) DEFAULT NULL,
                            ...
                            `orderprice` decimal(16,9) DEFAULT NULL,
                            `orderpricecurrency` int(10) UNSIGNED DEFAULT NULL,
                            ...
                            `winterproofing` int(10) UNSIGNED DEFAULT NULL,
                            `isfj` varchar(1) DEFAULT NULL COMMENT '0-否 1-法检',
                            `discount` decimal(10,2) DEFAULT NULL
