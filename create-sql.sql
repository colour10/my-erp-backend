...
CREATE TABLE `dd_confirmorder` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='发货单';
...
CREATE TABLE `dd_corder_ctn` (
                               ...
                               `sys_delete_date` datetime DEFAULT NULL,
                               `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                               `corderid` int(10) unsigned DEFAULT NULL COMMENT '外键ID(发货单ID)',
                               `ctnno` varchar(50) DEFAULT NULL COMMENT '箱号',
                               `length` decimal(16,9) DEFAULT NULL COMMENT '长',
                               `width` decimal(16,9) DEFAULT NULL COMMENT '宽',
                               `height` decimal(16,9) DEFAULT NULL COMMENT '高',
                               `weight` decimal(16,9) DEFAULT NULL COMMENT '重量',
                               `cbm` decimal(16,9) DEFAULT NULL COMMENT '计费重量',
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COMMENT='发货单明细';
...
CREATE TABLE `dd_fee` (
                        ...
                        `sys_delete_date` datetime DEFAULT NULL,
                        `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                        `dd_id` int(10) unsigned DEFAULT NULL COMMENT '费用来源表ID',
                        `feeid` int(10) unsigned DEFAULT NULL COMMENT '费用名称ID',
                        `currencyid` int(10) unsigned DEFAULT NULL COMMENT '货币类型',
                        `unitprice` decimal(10,2) DEFAULT NULL COMMENT '单价',
                        `amount` decimal(10,2) DEFAULT NULL COMMENT '数量',
                        `sum` decimal(10,2) DEFAULT NULL COMMENT '费用金额',
                        `companyid` int(10) unsigned DEFAULT NULL COMMENT '公司ID',
                        `sorf` varchar(1) DEFAULT NULL COMMENT '收付费标记：s-收 f-付',
                        `applyflag` varchar(1) DEFAULT NULL COMMENT '申请标记：0-未申请 1-已申请',
                        `applyid` int(10) unsigned DEFAULT NULL COMMENT '费用申请单ID',
                        `goodstotal` decimal(10,2) DEFAULT NULL COMMENT '总货款',
                        `deduct` decimal(10,2) DEFAULT NULL COMMENT '抵扣定金数',
                        `actuallypaid` decimal(10,2) DEFAULT NULL COMMENT '实际支付数',
                        `amortized` tinyint(4) DEFAULT NULL COMMENT '摊销标记',
                        `exchangerate` decimal(16,9) DEFAULT NULL COMMENT '汇率',
                        `standarysum` decimal(10,2) DEFAULT NULL COMMENT '本币金额',
                        PRIMARY KEY (`id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COMMENT='订单主表';
...
CREATE TABLE `dd_orderdetails` (
  ...
  `price` decimal(16,9) DEFAULT NULL,
  `actualnumber` int(11) DEFAULT NULL COMMENT '发货数量',
...
CREATE TABLE `dd_quotation` (
                              ...
                              `year_season` varchar(10) DEFAULT NULL COMMENT '供货商ID',
                              `rate` decimal(16,9) DEFAULT NULL COMMENT '附加费率',
...
CREATE TABLE `dd_quotation_detail` (
                                     ...
                                     `sys_delete_date` datetime DEFAULT NULL,
                                     `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                     `quotationid` int(10) unsigned DEFAULT NULL COMMENT '报价表ID',
                                     `productid` int(10) unsigned DEFAULT NULL COMMENT '商品ID',
                                     `ordernumber` int(11) DEFAULT NULL COMMENT '序号',
                                     `pic1` varchar(200) DEFAULT NULL COMMENT '图片1',
                                     `pic2` varchar(200) DEFAULT NULL COMMENT '图片2',
                                     `pic3` varchar(200) DEFAULT NULL COMMENT '图片3',
                                     `pic4` varchar(200) DEFAULT NULL COMMENT '图片4',
                                     `price` decimal(16,9) DEFAULT NULL COMMENT '单价',
                                     `item` varchar(100) DEFAULT NULL COMMENT '商品名称',
                                     `sizeid` int(10) unsigned DEFAULT NULL COMMENT '尺码',
                                     `memo` varchar(1000) DEFAULT NULL COMMENT '备注',
                                     `savesize` varchar(50) DEFAULT NULL COMMENT '保存尺码',
                                     PRIMARY KEY (`id`)
...
CREATE TABLE `if_cfashion` (
                             ...
                             `sys_delete_date` datetime DEFAULT NULL,
                             `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                             `creationtime` datetime DEFAULT NULL COMMENT '时间戳',
                             `productid` int(10) unsigned DEFAULT NULL COMMENT '商品ID',
                             `currencyunit` varchar(50) DEFAULT NULL COMMENT '币种',
                             `memo` text COMMENT '描述',
                             `mprice` decimal(18,0) DEFAULT NULL COMMENT '',
                             `price` decimal(18,0) DEFAULT NULL COMMENT '',
                             `del` int(11) DEFAULT NULL COMMENT '',
                             `operationtype` int(11) DEFAULT NULL COMMENT '操作类型：0-添加 1-修改',
                             `returnstate` int(11) DEFAULT NULL COMMENT '返回结果',
                             `returntext` text COMMENT '返回信息',
                             `cprice` decimal(18,0) DEFAULT NULL COMMENT '成交价',
                             `sourcefunction` varchar(50) DEFAULT NULL COMMENT '来源方法',
                             `sizecontentid` int(10) unsigned DEFAULT NULL COMMENT '尺码ID',
                             `sku` varchar(50) DEFAULT NULL COMMENT '',
                             `stockchange` varchar(500) DEFAULT NULL COMMENT '库存数',
                             `imglist` text COMMENT '上传图片地址',
                             PRIMARY KEY (`id`)
...
CREATE TABLE `tb_department` (
                               ...
                               `spotid` int(10) unsigned DEFAULT NULL COMMENT '销售端口id',
                               `up_dp_id` int(10) unsigned DEFAULT '0' COMMENT '上级部门ID',
                               `checkingflag` varchar(1) DEFAULT NULL COMMENT '核算部门',
                               PRIMARY KEY (`id`),
                               KEY `companyid` (`companyid`),
...
CREATE TABLE `tb_express` (
                            ...
                            `expressfee` decimal(16,9) DEFAULT NULL COMMENT '付款金额',
                            `memo` text COMMENT '备注',
                            `creator` int(10) unsigned NOT NULL COMMENT '制单人',
                            `departmentid` int(10) unsigned DEFAULT NULL COMMENT '核算部门',
                            `type` varchar(1) DEFAULT NULL COMMENT '0-个人，1-部门，2-事业部，3-公司',
                            `f_person` varchar(50) DEFAULT NULL COMMENT '发件人',
                            `f_telno` varchar(50) DEFAULT NULL COMMENT '发件人电话',
                            `f_address` varchar(500) DEFAULT NULL COMMENT '发件人地址',
                            `s_person` varchar(50) DEFAULT NULL COMMENT '收件人',
                            `s_telno` varchar(50) DEFAULT NULL COMMENT '收件人电话',
                            `s_address` varchar(500) DEFAULT NULL COMMENT '收件人地址',
                            PRIMARY KEY (`id`)
...
CREATE TABLE `tb_member` (
                           ...
                           `password` varchar(10) DEFAULT NULL COMMENT '消费密码',
...
CREATE TABLE `tb_member_address` (
                                   ...
                                   `idno` varchar(50) DEFAULT NULL COMMENT '身份证号',
                                   `tel` varchar(50) DEFAULT NULL COMMENT '收货人电话',
                                   `zipcode` varchar(10) DEFAULT NULL COMMENT '邮编',
...
CREATE TABLE `tb_member_bank` (
                                ...
                                `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                `memberid` int(10) unsigned DEFAULT NULL COMMENT '会员id',
                                `account_name` varchar(1000) DEFAULT NULL COMMENT '账户名',
                                `account` varchar(1000) DEFAULT NULL COMMENT '帐号',
                                `currencyid` int(10) unsigned DEFAULT NULL COMMENT '开户币种',
                                `bank_name` varchar(1000) DEFAULT NULL COMMENT '银行名称',
...
CREATE TABLE `tb_member_card` (
                                ...
                                `is_used` varchar(1) DEFAULT NULL COMMENT '是否使用：0-否 1-是',
                                PRIMARY KEY (`id`)
...
CREATE TABLE `tb_member_contactor` (
                                     ...
                                     `form` varchar(1) DEFAULT NULL COMMENT '性别：f-female\r\n            m-male',
                                     `birth` date DEFAULT NULL COMMENT '出生日期',
                                     `tel` varchar(50) DEFAULT NULL COMMENT '固话',
                                     `phoneno` varchar(50) DEFAULT NULL COMMENT '手机号',
                                     `email` varchar(50) DEFAULT NULL COMMENT '邮箱',
                                     `address` varchar(50) DEFAULT NULL COMMENT '地址',
                                     `zipcode` varchar(10) DEFAULT NULL COMMENT '邮编',
...
CREATE TABLE `tb_member_header` (
                                  ...
                                  `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                  `memberid` int(10) unsigned DEFAULT NULL COMMENT '会员id',
                                  `chinese_header` varchar(1000) DEFAULT NULL COMMENT '中文抬头',
                                  `english_header` varchar(1000) DEFAULT NULL COMMENT '英文抬头',
                                  `is_default` varchar(1) DEFAULT NULL COMMENT '是否默认：0-否 1-是',
                                  PRIMARY KEY (`id`)
...
CREATE TABLE `tb_member_preference` (
                                      ...
                                      `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                      `memberid` int(10) unsigned DEFAULT NULL COMMENT '会员id',
                                      `brandid` int(10) unsigned DEFAULT NULL COMMENT '品牌id',
                                      `brandgroupid` int(10) unsigned DEFAULT NULL COMMENT '品类id',
                                      `childbrandgroupid` int(10) unsigned DEFAULT NULL COMMENT '子品类id',
                                      `sizetopid` int(10) unsigned DEFAULT NULL COMMENT '尺码组id',
                                      PRIMARY KEY (`id`)
...
CREATE TABLE `tb_member_preference_size` (
                                           ...
                                           `sys_delete_date` datetime DEFAULT NULL,
                                           `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                           `memberpreferenceid` int(10) unsigned DEFAULT NULL COMMENT '会员偏好id',
                                           `sizecontentid` int(10) unsigned DEFAULT NULL COMMENT '尺码id',
                                           `sizetopid` int(10) unsigned DEFAULT NULL COMMENT '尺码组id',
                                           PRIMARY KEY (`id`)
...
CREATE TABLE `tb_product_price` (
                                  ...
                                  `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                  `productid` int(10) unsigned DEFAULT NULL COMMENT '商品ID',
                                  `decadeid` int(10) unsigned DEFAULT NULL COMMENT '年代ID',
                                  `retailpricecurrency` int(10) unsigned DEFAULT NULL COMMENT '成交价币种',
                                  `realprice` decimal(16,9) DEFAULT NULL COMMENT '成交价',
                                  `factorypricecurrency` int(10) unsigned DEFAULT NULL COMMENT '参考价币种',
                                  `factoryprice` decimal(16,9) DEFAULT NULL COMMENT '参考价',
                                  `basecurrency` int(10) unsigned DEFAULT NULL COMMENT '基准零售价币种',
                                  `baseprice` decimal(16,9) DEFAULT NULL COMMENT '基准零售价',
                                  `nationalprice` decimal(16,9) DEFAULT NULL COMMENT '国内零售价',
                                  PRIMARY KEY (`id`)
...
CREATE TABLE `tb_productstock` (
                                 ...
                                 `storagestaff` int(10) unsigned DEFAULT NULL COMMENT '入库办理人',
                                 `warehouseid` int(10) unsigned DEFAULT NULL COMMENT '仓库id',
                                 `productno` bigint(20) DEFAULT NULL COMMENT '唯一编号7位长度',
                                 `selltime` datetime DEFAULT NULL COMMENT '销售时间',
                                 `sellprice` decimal(16,9) DEFAULT NULL COMMENT '标价',
                                 `cost` decimal(16,9) DEFAULT NULL COMMENT '成本',
                                 `selltype` int(11) DEFAULT NULL COMMENT '0-待销\n            1-已售出\n            2-预售\n            3-在途\n            4-调拨锁定',
                                 `dealprice` decimal(16,9) DEFAULT NULL COMMENT '实际成交价格',
                                 `qualitystatus` int(11) DEFAULT NULL COMMENT '0-合格品\n            1-残次品\n            2-库存差异',
                                 `sellstaff` int(10) unsigned DEFAULT NULL COMMENT '销售办理人',
                                 `is_print` varchar(1) DEFAULT NULL COMMENT '0-未打印\n            1-条形码打印\n            2-二维码打印',
                                 `corderid` int(10) unsigned DEFAULT NULL COMMENT '入库单ID',
                                 `currencyid` int(10) unsigned DEFAULT NULL COMMENT '币种ID',
                                 `memo` varchar(500) DEFAULT NULL COMMENT '备注',
                                 `cpdate` datetime DEFAULT NULL COMMENT '定残日期',
                                 `cp_op` int(10) unsigned DEFAULT NULL COMMENT '标残操作人',
                                 `intime` datetime DEFAULT NULL COMMENT '到店时间',
                                 `property` varchar(1) DEFAULT NULL COMMENT '0-自采 1-代销',
...
CREATE TABLE `tb_productstock_snapshot` (
                                          ...
                                          `sys_delete_date` datetime DEFAULT NULL,
                                          `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                          `snapdate` datetime DEFAULT NULL COMMENT '快照时间',
                                          `productstockid` int(10) unsigned DEFAULT NULL COMMENT '库存ID',
                                          `productid` int(10) unsigned DEFAULT NULL COMMENT '商品ID',
                                          `sizecontentid` int(10) unsigned DEFAULT NULL COMMENT '尺码ID',
                                          `stockid` int(10) unsigned DEFAULT NULL COMMENT '仓库ID',
                                          `productno` bigint(20) DEFAULT NULL COMMENT '商品唯一编号7位长度',
                                          `selltime` datetime DEFAULT NULL COMMENT '销售时间',
                                          `sellprice` decimal(16,9) DEFAULT NULL COMMENT '标价',
                                          `cost` decimal(16,9) DEFAULT NULL COMMENT '成本',
                                          `selltype` int(11) DEFAULT NULL COMMENT '销售类型：0-待销\r\n            1-已售出\r\n            2-预定\r\n            3-在途\r\n            4-调拨锁定',
                                          `dealprice` decimal(16,9) DEFAULT NULL COMMENT '实际成交价格',
                                          `qualitystatus` int(11) DEFAULT NULL COMMENT '商品质量状态：0-合格品\r\n            1-残次品\r\n            2-库存差异',
                                          `sellstaff` int(10) unsigned DEFAULT NULL COMMENT '销售办理人',
                                          `corderid` int(10) unsigned DEFAULT NULL COMMENT '入库单ID',
                                          `currencyid` int(10) unsigned DEFAULT NULL COMMENT '币种ID',
                                          `memo` varchar(500) DEFAULT NULL COMMENT '备注',
                                          `cpdate` datetime DEFAULT NULL COMMENT '定残日期',
                                          `intime` datetime DEFAULT NULL COMMENT '到店时间',
                                          `property` varchar(1) DEFAULT NULL COMMENT '商品属性：0-自采 1-代销',
                                          `kpflag` varchar(1) DEFAULT NULL COMMENT '开票标志：0-未开票 1-已开票',
                                          `decadeid` int(10) unsigned NOT NULL COMMENT '到货年代',
                                          PRIMARY KEY (`id`)
...
CREATE TABLE `tb_requisition` (
                                ...
                                `sys_delete_date` datetime DEFAULT NULL,
                                `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                `feecurrencyid` int(10) unsigned DEFAULT NULL COMMENT '相关费用币种',
                                `fee` decimal(16,9) DEFAULT NULL COMMENT '相关费用',
                                `applystaff` int(10) unsigned DEFAULT NULL COMMENT '制单_操作人',
                                `applydate` datetime NOT NULL COMMENT '制单时间',
                                `turninstaff` int(10) unsigned DEFAULT NULL COMMENT '调入_操作人',
                                `turnindate` datetime DEFAULT NULL COMMENT '调入时间',
                                `turnoutstaff` int(10) unsigned NOT NULL COMMENT '调出_操作人',
                                `turnoutdate` datetime DEFAULT NULL COMMENT '调出时间',
                                `outid` int(10) unsigned NOT NULL COMMENT '调出库id',
                                `inid` int(10) unsigned NOT NULL COMMENT '调入库id',
                                `memo` varchar(500) DEFAULT NULL COMMENT '备注',
                                `allocationconfirm` varchar(1) DEFAULT NULL COMMENT 'null-主调拨单才会是这个\r\n            4-出库未完成\r\n            0-入库未完成\r\n            1-出库拒绝\r\n            2-已完成\r\n            3-入库拒绝\r\n            ',
                                `requisitionno` varchar(50) DEFAULT NULL COMMENT '调拨单号',
                                `salesid` int(10) unsigned DEFAULT NULL COMMENT '销售单id',
                                `ism` varchar(1) DEFAULT NULL COMMENT '1-主单，0或者空-子单或单对单库调拨单',
                                `qualitystatus` varchar(1) DEFAULT NULL COMMENT '0-合格品 1-残品',
                                `isamortized` varchar(1) DEFAULT NULL COMMENT '是否摊销费用',
                                `expresscomoany` varchar(1) DEFAULT NULL COMMENT '0-顺丰 1-德邦 2-京东 3-其他',
                                `address` char(1) DEFAULT NULL COMMENT '收货地址',
                                `markno` varchar(50) DEFAULT NULL COMMENT '唛头流水号',
                                `returnflag` varchar(1) DEFAULT NULL COMMENT '反向调拨单标记：0-普通调拨单，1-反向调拨单',
                                PRIMARY KEY (`id`)
...
CREATE TABLE `tb_supplier` (
                             ...
                             `sys_delete_date` datetime DEFAULT NULL,
                             `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                             `name` varchar(50) DEFAULT NULL COMMENT '供货商中文名称',
                             `englishname` varchar(50) DEFAULT NULL COMMENT '供货商英文名称',
                             `address` varchar(100) DEFAULT NULL COMMENT '地址',
                             `phone` varchar(30) DEFAULT NULL COMMENT '电话',
                             `zipcode` varchar(500) DEFAULT NULL COMMENT '邮政编码',
                             `email` varchar(500) DEFAULT NULL COMMENT '邮箱',
                             `quotedprice` varchar(20) DEFAULT NULL COMMENT '报价',
                             `developdate` datetime DEFAULT NULL COMMENT '开发日期',
                             `nationality` int(10) unsigned DEFAULT NULL COMMENT '国籍',
                             `nature` varchar(100) DEFAULT NULL COMMENT '性质',
                             `supplierlevel` int(10) unsigned DEFAULT NULL COMMENT '供货商级别',
                             `companyzipcode` varchar(100) DEFAULT NULL COMMENT '公司邮箱',
                             ...
                             `heading` varchar(50) DEFAULT NULL COMMENT '税号',
                             `businesslicense` varchar(50) DEFAULT NULL COMMENT '营业执照号',
                             `headingnumber` varchar(50) DEFAULT NULL COMMENT '税务登记证号',
                             `registered` varchar(10) DEFAULT NULL COMMENT '注册时间',
                             `registeredcapital` decimal(15,0) DEFAULT NULL COMMENT '注册资本',
                             `endtime` varchar(10) DEFAULT NULL COMMENT '终止时间',
                             `type` varchar(1) DEFAULT NULL COMMENT '类型(改为多选，暂不使用)：0-供货商 1-报关行 2-供应商 3-承运人 4-客户 5-品牌商',
                             `contractfrom` datetime DEFAULT NULL COMMENT '合同有效期开始',
                             `contractto` datetime DEFAULT NULL COMMENT '合同有效期截至',
                             `contractrate` decimal(16,9) DEFAULT NULL COMMENT '协议扣点',
                             `contractremind` int(11) DEFAULT NULL COMMENT '合同到期提前提醒天数',
...
CREATE TABLE `tb_user` (
                         ...
                         `departmentid` int(10) unsigned DEFAULT NULL COMMENT '事业部id',
                         `companyid` int(10) unsigned DEFAULT NULL COMMENT '公司id',
                         `groupid` int(10) unsigned DEFAULT NULL COMMENT '组ID',
                         `storeid` int(10) unsigned DEFAULT NULL COMMENT '所属门店仓库',
                         `sys_create_stuff` int(10) unsigned NOT NULL,
                         `sys_create_date` datetime NOT NULL,
                         `sys_modify_stuff` int(10) unsigned NOT NULL,
                         `sys_modify_date` datetime NOT NULL,
                         ...
                         `section` varchar(50) DEFAULT NULL COMMENT '',
                         `date` varchar(100) DEFAULT NULL COMMENT '',
                         `phone` varchar(50) DEFAULT NULL COMMENT '电话号码 ',
                         `mobilephone` varchar(50) DEFAULT NULL COMMENT '手机号码 ',
                         `e_mail` varchar(100) DEFAULT NULL COMMENT '邮箱',
                         `email_password` varchar(50) DEFAULT NULL COMMENT '邮箱密码，用于自动发送邮件',
                         `comment` varchar(100) DEFAULT NULL COMMENT '',
                         `countryid` int(10) unsigned DEFAULT NULL COMMENT '国家区域ID',
                         `departmentid2` int(10) unsigned DEFAULT NULL COMMENT '部门id',
                         `address` text COMMENT '地址',
                         `contactor` text COMMENT '备用联系人',
                         `leave_date` varchar(100) DEFAULT NULL COMMENT '离职时间',
                         `defaultprice` int(10) unsigned DEFAULT NULL COMMENT '默认价格单',
                         `defaultwarehouse` int(10) unsigned DEFAULT NULL COMMENT '默认仓库',
                         `defaultsellspot` int(10) unsigned DEFAULT NULL COMMENT '默认销售端口',
                         `idno` varchar(20) DEFAULT NULL COMMENT '身份证号',
                         `education` varchar(50) DEFAULT NULL COMMENT '学历',
                         `collegemajor` varchar(50) DEFAULT NULL COMMENT '专业',
                         `degree` varchar(50) DEFAULT NULL COMMENT '学位',
                         `graduatedcollege` varchar(50) DEFAULT NULL COMMENT '毕业院校',
                         `stateofmarriage` varchar(50) DEFAULT NULL COMMENT '婚/育状况',
                         `censusregistration` varchar(50) DEFAULT NULL COMMENT '户籍所在地',
                         `status` varchar(1) DEFAULT NULL COMMENT '0-在职，1-离职，2-其他',
                         `reason` text COMMENT '离职原因',
                         `contactorphone` varchar(50) DEFAULT NULL COMMENT '备用联系人手机号',
                         `costdisplay` varchar(1) DEFAULT NULL COMMENT '显示成本',
...
CREATE TABLE `tb_warehouse` (
                              ...
                              `toll` varchar(20) DEFAULT NULL COMMENT '电话',
                              `fax` varchar(20) DEFAULT NULL COMMENT '传真',
                              `mobile` varchar(20) DEFAULT NULL COMMENT '手机',
                              `othercontact` varchar(50) DEFAULT NULL COMMENT '其他联系方式',
                              `code` varchar(20) DEFAULT NULL COMMENT '编号',
                              `defaultstore` varchar(1) DEFAULT NULL COMMENT '默认库标示',
                              `zipcode` varchar(10) DEFAULT NULL COMMENT '邮编',
                              `is_real` varchar(1) DEFAULT NULL COMMENT '是否可用库存',
                              `maxstock` bigint(20) DEFAULT NULL COMMENT '库存上限',
                              `maxsku` bigint(20) DEFAULT NULL COMMENT '款数上限',
                              PRIMARY KEY (`id`)
...
CREATE TABLE `tb_warehousing` (
                                ...
                                `sys_delete_date` datetime DEFAULT NULL,
                                `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                `arrivalid` int(10) unsigned DEFAULT NULL COMMENT '到货单ID(暂时没用)',
                                `entrydate` datetime NOT NULL COMMENT '入库时间',
                                `warehouseid` int(10) unsigned NOT NULL COMMENT '仓库ID',
                                `season` int(10) unsigned DEFAULT NULL COMMENT '年份季节',
                                `seasontype` varchar(1) DEFAULT NULL COMMENT '年代类型：0-pre ,1-main ,2-fashion show',
                                `opid` int(10) unsigned NOT NULL COMMENT '操作人',
                                `memo` varchar(500) DEFAULT NULL COMMENT '备注',
                                `ischecked` varchar(2) DEFAULT NULL COMMENT '是否审核',
                                `isamortized` varchar(2) DEFAULT NULL COMMENT '是否已平摊',
                                `entrycode` varchar(100) DEFAULT NULL COMMENT '入库单号',
                                `exchangerate` decimal(16,9) DEFAULT NULL COMMENT '汇率',
...
CREATE TABLE `tb_warehousing_detail` (
                                       ...
                                       `warehousingid` int(10) unsigned NOT NULL COMMENT '入库单id',
                                       `productid` int(10) unsigned NOT NULL COMMENT '商品id',
                                       `sizecontentid` int(10) unsigned NOT NULL COMMENT '尺码id',
                                       `amount` int(11) NOT NULL COMMENT '数量',
                                       `cost` decimal(16,9) NOT NULL COMMENT '成本',
                                       `memo` varchar(500) DEFAULT NULL COMMENT '备注',
                                       `cjj` decimal(16,9) DEFAULT NULL COMMENT '成交价',
                                       `yj` decimal(16,9) DEFAULT NULL COMMENT '佣金',
                                       `sellprice` decimal(16,9) DEFAULT NULL COMMENT '销售价格',
                                       `finalcost` decimal(16,9) DEFAULT NULL COMMENT '最终成本',
                                       `currencyid` int(10) unsigned DEFAULT NULL COMMENT '币种',
                                       PRIMARY KEY (`id`)
...
CREATE TABLE `tb_warehousing_fee` (
                                    ...
                                    `sys_delete_date` datetime DEFAULT NULL,
                                    `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                    `warehousingid` int(10) unsigned DEFAULT NULL COMMENT '入库表ID',
                                    `feeid` int(10) unsigned DEFAULT NULL COMMENT '费用名称ID',
                                    `currencyid` int(10) unsigned DEFAULT NULL COMMENT '货币类型',
                                    `feeprice` decimal(10,2) DEFAULT NULL COMMENT '费用',
                                    `payment` int(10) unsigned DEFAULT NULL COMMENT '付款单位',
                                    PRIMARY KEY (`id`)
...
CREATE TABLE `trans_brand_code` (
                                  ...
                                  `transcode` varchar(50) DEFAULT NULL COMMENT '对照码',
                                  `unit` varchar(10) DEFAULT NULL COMMENT '单位对照码',
                                  PRIMARY KEY (`id`)
...
CREATE TABLE `trans_color_code` (
                                  ...
                                  `sys_delete_date` datetime DEFAULT NULL,
                                  `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                  `colorid` int(10) unsigned DEFAULT NULL COMMENT '颜色ID',
                                  `code` varchar(50) DEFAULT NULL COMMENT '代码',
                                  `transcode` varchar(50) DEFAULT NULL COMMENT '对照码',
                                  PRIMARY KEY (`id`)
...
CREATE TABLE `trans_group_code` (
                                  ...
                                  `sys_delete_date` datetime DEFAULT NULL,
                                  `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                  `groupid` int(10) unsigned DEFAULT NULL COMMENT '子品类ID',
                                  `code` varchar(50) DEFAULT NULL COMMENT '代码',
                                  `transcode` varchar(50) DEFAULT NULL COMMENT '对照码',
                                  PRIMARY KEY (`id`)
...
CREATE TABLE `trans_size_code` (
                                 ...
                                 `sys_delete_date` datetime DEFAULT NULL,
                                 `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                 `sizeid` int(10) unsigned DEFAULT NULL COMMENT '尺码ID',
                                 `typeid` int(10) unsigned DEFAULT NULL COMMENT '品类ID',
                                 `code` varchar(50) DEFAULT NULL COMMENT '代码',
                                 `transcode` varchar(50) DEFAULT NULL COMMENT '对照码',
                                 PRIMARY KEY (`id`)
...
CREATE TABLE `xs_afterservice` (
                                 ...
                                 `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                 `memberid` int(10) unsigned DEFAULT NULL COMMENT '会员ID',
                                 `salesstaff` int(10) unsigned DEFAULT NULL COMMENT '售后人员',
                                 `salesdate` datetime DEFAULT NULL COMMENT '售后时间',
                                 `sellspotid` int(10) unsigned DEFAULT NULL COMMENT '售后端口ID',
                                 `saleno` varchar(50) DEFAULT NULL COMMENT '售后单号',
                                 `cusname` varchar(50) DEFAULT NULL COMMENT '顾客姓名',
                                 `custel` varchar(50) DEFAULT NULL COMMENT '顾客联系方式',
                                 `status` varchar(1) DEFAULT NULL COMMENT '处理状态：0-接收 1-处理中 2-完结',
                                 PRIMARY KEY (`id`)
...
CREATE TABLE `xs_afterservice_detail` (
                                        ...
                                        `sys_delete_date` datetime DEFAULT NULL,
                                        `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                        `afterserviceid` int(10) unsigned DEFAULT NULL COMMENT '售后单ID',
                                        `detailid` int(10) unsigned DEFAULT NULL COMMENT '销售明细ID',
                                        `count` int(11) DEFAULT NULL COMMENT '数量',
                                        `memo` varchar(500) DEFAULT NULL COMMENT '商品印象',
                                        `dealtype` varchar(1) DEFAULT NULL COMMENT '0-修理1-保养2-调换3-退货',
                                        `fixdate` datetime DEFAULT NULL COMMENT '送修日期',
                                        `fixstuff` int(10) unsigned DEFAULT NULL COMMENT '送修经手人',
                                        `backdate` datetime DEFAULT NULL COMMENT '取回日期',
                                        `backstuff` int(10) unsigned DEFAULT NULL COMMENT '取回经手人',
                                        PRIMARY KEY (`id`)
...
CREATE TABLE `xs_sales` (
                          ...
                          `salestype` varchar(1) DEFAULT NULL COMMENT '销售转发货标记：0-未转 1-已转',
                          ...
                          `expressfee` decimal(16,9) DEFAULT NULL COMMENT '付款金额',
                          `expressfeepayid` int(10) unsigned DEFAULT NULL COMMENT '付款人',
                          `status` varchar(1) DEFAULT NULL COMMENT '0-预售 1-已售 2-作废',
                          `expresscomoany` varchar(1) DEFAULT NULL COMMENT '快递公司：0-顺丰 1-德邦 2-京东 3-其他 4-圆通',
                          `address` int(10) unsigned DEFAULT NULL COMMENT '收货地址',
                          ...
                          `sender` int(10) unsigned DEFAULT NULL COMMENT '送货人',
                          `supplierid` int(10) unsigned DEFAULT NULL COMMENT '结算单位ID',
                          `isjf` varchar(1) DEFAULT NULL COMMENT '0-未使用积分抵扣，1-使用积分抵扣',
                          `dksum` decimal(16,9) DEFAULT NULL COMMENT '抵扣金额',
                          `usedscore` bigint(20) DEFAULT NULL COMMENT '使用积分',
                          `exhibitionid` int(10) unsigned DEFAULT NULL COMMENT '展会说明',
                          `isused` varchar(1) DEFAULT NULL COMMENT '是否使用推荐账户',
                          `invitesum` bigint(20) DEFAULT NULL COMMENT '使用推荐账户金额',
                          PRIMARY KEY (`id`)
...
CREATE TABLE `xs_salesdetails` (
                                 ...
                                 `dealprice` decimal(16,9) DEFAULT NULL COMMENT '成交价格',
                                 `price` decimal(16,9) DEFAULT NULL COMMENT '单价',
                                 `rate` decimal(16,9) DEFAULT NULL COMMENT '折扣',
                                 `memo` varchar(500) DEFAULT NULL COMMENT '备注',
                                 ...
                                 `exchangerate` decimal(16,9) DEFAULT NULL COMMENT '汇率',
                                 `totalsellpricebwb` decimal(16,9) DEFAULT NULL COMMENT '本位币合计',
                                 PRIMARY KEY (`id`)
...
CREATE TABLE `zl_invite_rule` (
                                ...
                                `sys_delete_date` datetime DEFAULT NULL,
                                `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                `bonus` bigint(20) DEFAULT NULL COMMENT '赠送积分',
                                `memo_cn` text COMMENT '中文备注',
                                `memo_en` text COMMENT '英文备注',
                                `memo_hk` text COMMENT '粤语备注',
                                `memo_fr` text COMMENT '法语备注',
...
CREATE TABLE `zl_memberlevel` (
                                ...
                                `sys_delete_date` datetime DEFAULT NULL,
                                `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                `name_cn` varchar(100) DEFAULT NULL COMMENT '用户等级名-中文名称',
                                `name_en` varchar(100) DEFAULT NULL COMMENT '用户等级名-英文名称',
                                `name_hk` varchar(100) DEFAULT NULL COMMENT '用户等级名-粤语名称',
                                `name_fr` varchar(100) DEFAULT NULL COMMENT '用户等级名-法语名称',
                                `name_it` varchar(100) DEFAULT NULL COMMENT '用户等级名-意大利语名称',
                                `name_sp` varchar(100) DEFAULT NULL COMMENT '用户等级名-西班牙语名称',
                                `name_de` varchar(100) DEFAULT NULL COMMENT '用户等级名-德语名称',
                                `discount` decimal(16,9) DEFAULT NULL COMMENT '折扣率',
                                `levelbasicscore` bigint(20) DEFAULT NULL COMMENT '等级最低积分',
                                ...
                                `content_cn` varchar(100) DEFAULT NULL COMMENT '等级内容-中文',
                                `content_en` varchar(100) DEFAULT NULL COMMENT '等级内容-英文',
                                `content_hk` varchar(100) DEFAULT NULL COMMENT '等级内容-粤语',
                                `content_fr` varchar(100) DEFAULT NULL COMMENT '等级内容-法语',
                                `content_it` varchar(100) DEFAULT NULL COMMENT '等级内容-意大利语',
                                `content_sp` varchar(100) DEFAULT NULL COMMENT '等级内容-西班牙语',
                                `content_de` varchar(100) DEFAULT NULL COMMENT '等级内容-德语',
...
INSERT INTO `tb_permission` (`id`, `sys_create_stuff`, `sys_create_date`, `sys_modify_stuff`, `sys_modify_date`, `sys_delete_stuff`, `sys_delete_date`, `sys_delete_flag`, `pid`, `name`, `memo_cn`, `memo_en`, `memo_hk`, `memo_fr`, `memo_it`, `memo_sp`, `memo_de`, `is_only_superadmin`, `code`) VALUES
(1, 1, '2019-03-08 13:37:45', 1, '2019-03-08 13:37:45', NULL, NULL, 0, 0, 'userControl', '用户管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '001'),
(2, 1, '2019-03-08 13:40:21', 1, '2019-03-08 13:40:21', NULL, NULL, 0, 0, 'databaseControl', '基础数据', NULL, NULL, NULL, NULL, NULL, NULL, 0, '002'),
(3, 1, '2019-03-08 13:42:08', 1, '2019-03-08 13:42:08', NULL, NULL, 0, 0, 'productControl', '商品管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '003'),
(4, 1, '2019-03-08 13:43:12', 1, '2019-03-08 13:43:12', NULL, NULL, 0, 0, 'customControl', '客户管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '004'),
(5, 1, '2019-03-08 13:45:10', 1, '2019-03-08 13:45:10', NULL, NULL, 0, 0, 'supplierControl', '供应链管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '005'),
(6, 1, '2019-03-08 13:45:34', 1, '2019-03-08 13:45:34', NULL, NULL, 0, 0, 'stockControl', '库存管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '006'),
(7, 1, '2019-03-08 13:46:13', 1, '2019-03-08 13:46:13', NULL, NULL, 0, 0, 'salesControl', '销售管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '007'),
(8, 1, '2019-03-08 13:46:40', 1, '2019-03-08 13:46:40', NULL, NULL, 0, 0, 'memberControl', '会员管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '008'),
(9, 1, '2019-03-08 13:47:16', 1, '2019-03-08 13:47:16', NULL, NULL, 0, 0, 'costControl', '费用管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '009'),
(10, 1, '2019-03-08 13:48:08', 1, '2019-03-08 13:48:08', NULL, NULL, 0, 0, 'financialControl', '财务管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '010'),
(11, 1, '2019-03-08 13:48:42', 1, '2019-03-08 13:48:42', NULL, NULL, 0, 0, 'systemControl', '系统管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '011'),
(12, 1, '2019-03-08 13:50:11', 1, '2019-03-08 13:50:11', NULL, NULL, 0, 1, 'user', '员工信息', NULL, NULL, NULL, NULL, NULL, NULL, 0, '012'),
(13, 1, '2019-03-08 13:51:06', 1, '2019-03-08 13:51:06', NULL, NULL, 0, 1, 'group', '组信息', NULL, NULL, NULL, NULL, NULL, NULL, 0, '013'),
(14, 1, '2019-03-08 13:51:24', 1, '2019-03-08 13:51:24', NULL, NULL, 0, 1, 'department', '部门信息', NULL, NULL, NULL, NULL, NULL, NULL, 0, '014'),
(15, 1, '2019-03-08 13:52:10', 1, '2019-03-08 13:52:10', NULL, NULL, 0, 2, 'productRelate', '商品相关', NULL, NULL, NULL, NULL, NULL, NULL, 0, '015'),
(16, 1, '2019-03-08 13:52:45', 1, '2019-03-08 13:52:45', NULL, NULL, 0, 2, 'priceRelate', '价格相关', NULL, NULL, NULL, NULL, NULL, NULL, 0, '016'),
(17, 1, '2019-03-08 13:56:20', 1, '2019-03-08 13:56:20', NULL, NULL, 0, 2, 'otherRelate', '其他', NULL, NULL, NULL, NULL, NULL, NULL, 0, '017'),
(18, 1, '2019-03-08 13:57:31', 1, '2019-03-08 13:57:31', NULL, NULL, 0, 3, 'product', '商品信息', NULL, NULL, NULL, NULL, NULL, NULL, 0, '018'),
(19, 1, '2019-03-08 13:57:53', 1, '2019-03-08 13:57:53', NULL, NULL, 0, 3, 'picture', '图片管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '019'),
(20, 1, '2019-03-08 14:04:10', 1, '2019-03-08 14:04:10', NULL, NULL, 0, 3, 'pictureupload', '图片上传', NULL, NULL, NULL, NULL, NULL, NULL, 0, '020'),
(21, 1, '2019-03-08 14:06:34', 1, '2019-03-08 14:06:34', NULL, NULL, 0, 4, 'supplier', '关系单位信息', NULL, NULL, NULL, NULL, NULL, NULL, 0, '021'),
(22, 1, '2019-03-08 14:12:25', 1, '2019-03-08 14:12:25', NULL, NULL, 0, 4, 'quotation', '供货商报价', NULL, NULL, NULL, NULL, NULL, NULL, 0, '022'),
(23, 1, '2019-03-08 14:17:08', 1, '2019-03-08 14:17:08', NULL, NULL, 0, 4, 'supplierlevel', '供货商级别', NULL, NULL, NULL, NULL, NULL, NULL, 0, '023'),
(24, 1, '2019-03-08 14:20:47', 1, '2019-03-08 14:20:47', NULL, NULL, 0, 5, 'orderRelate', '订单管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '024'),
(25, 1, '2019-03-08 14:27:24', 1, '2019-03-08 14:27:24', NULL, NULL, 0, 5, 'confirmorder', '发货单管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '025'),
(26, 1, '2019-03-08 14:34:21', 1, '2019-03-08 14:34:21', NULL, NULL, 0, 5, 'warehousingRelate', '到货入库', NULL, NULL, NULL, NULL, NULL, NULL, 0, '026'),
(27, 1, '2019-03-08 14:35:59', 1, '2019-03-08 14:35:59', NULL, NULL, 0, 6, 'requisitionRelate', '调拨相关', NULL, NULL, NULL, NULL, NULL, NULL, 0, '027'),
(28, 1, '2019-03-08 14:48:07', 1, '2019-03-08 14:48:07', NULL, NULL, 0, 6, 'checkRelate', '库存盘点', NULL, NULL, NULL, NULL, NULL, NULL, 0, '028'),
(29, 1, '2019-03-08 15:12:48', 1, '2019-03-08 15:12:48', NULL, NULL, 0, 6, 'stocksnapshot', '库存余额查询', NULL, NULL, NULL, NULL, NULL, NULL, 0, '029'),
(30, 1, '2019-03-08 15:13:20', 1, '2019-03-08 15:13:20', NULL, NULL, 0, 6, 'productstock', '库存查询', NULL, NULL, NULL, NULL, NULL, NULL, 0, '030'),
(31, 1, '2019-03-08 15:14:05', 1, '2019-03-08 15:14:05', NULL, NULL, 0, 6, 'productstockSnapshot', '库存快照统计', NULL, NULL, NULL, NULL, NULL, NULL, 0, '031'),
(32, 1, '2019-03-08 15:18:29', 1, '2019-03-08 15:18:29', NULL, NULL, 0, 7, 'sales', '商品零售批发', NULL, NULL, NULL, NULL, NULL, NULL, 0, '032'),
(33, 1, '2019-03-08 15:28:36', 1, '2019-03-08 15:28:36', NULL, NULL, 0, 7, 'salesstock', '销售端口库存统计', NULL, NULL, NULL, NULL, NULL, NULL, 0, '033'),
(34, 1, '2019-03-08 15:37:15', 1, '2019-03-08 15:37:15', NULL, NULL, 0, 7, 'sfRelate', '销售对账', NULL, NULL, NULL, NULL, NULL, NULL, 0, '034'),
(35, 1, '2019-03-08 15:38:04', 1, '2019-03-08 15:38:04', NULL, NULL, 0, 7, 'sale/statistics', '销售统计', NULL, NULL, NULL, NULL, NULL, NULL, 0, '035'),
(36, 1, '2019-03-08 15:39:08', 1, '2019-03-08 15:39:08', NULL, NULL, 0, 8, 'member', '会员管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '036'),
(37, 1, '2019-03-08 15:39:37', 1, '2019-03-08 15:39:37', NULL, NULL, 0, 8, 'memberlevel', '会员级别', NULL, NULL, NULL, NULL, NULL, NULL, 0, '037'),
(38, 1, '2019-03-08 16:04:26', 1, '2019-03-08 16:04:26', NULL, NULL, 0, 9, 'fee', '费用申请', NULL, NULL, NULL, NULL, NULL, NULL, 0, '038'),
(39, 1, '2019-03-08 16:08:03', 1, '2019-03-08 16:08:03', NULL, NULL, 0, 9, 'fee/leader', '费用申请主管审批', NULL, NULL, NULL, NULL, NULL, NULL, 0, '039'),
(40, 1, '2019-03-08 16:08:30', 1, '2019-03-08 16:08:30', NULL, NULL, 0, 9, 'fee/finance', '费用申请财务审批', NULL, NULL, NULL, NULL, NULL, NULL, 0, '040'),
(41, 1, '2019-03-08 16:10:11', 1, '2019-03-08 16:10:11', NULL, NULL, 0, 9, 'fee/manager', '费用申请经理审批', NULL, NULL, NULL, NULL, NULL, NULL, 0, '041'),
(42, 1, '2019-03-08 16:12:20', 1, '2019-03-08 16:12:20', NULL, NULL, 0, 10, 'sfsheet', '对账查询', NULL, NULL, NULL, NULL, NULL, NULL, 0, '042'),
(43, 1, '2019-03-08 16:18:42', 1, '2019-03-08 16:18:42', NULL, NULL, 0, 11, 'help', '系统帮助', NULL, NULL, NULL, NULL, NULL, NULL, 0, '043'),
(44, 1, '2019-03-08 16:20:49', 1, '2019-03-08 16:20:49', NULL, NULL, 0, 11, 'modifypassword', '修改密码', NULL, NULL, NULL, NULL, NULL, NULL, 0, '044'),
(45, 1, '2019-03-08 16:21:09', 1, '2019-03-08 16:21:09', NULL, NULL, 0, 11, 'logout', '退出登录', NULL, NULL, NULL, NULL, NULL, NULL, 0, '045'),
(46, 1, '2019-03-08 17:33:06', 1, '2019-03-08 17:33:06', NULL, NULL, 0, 15, 'brand', '品牌维护', NULL, NULL, NULL, NULL, NULL, NULL, 0, '046'),
(47, 1, '2019-03-08 17:33:41', 1, '2019-03-08 17:33:41', NULL, NULL, 0, 15, 'brandgroup', '品类维护', NULL, NULL, NULL, NULL, NULL, NULL, 0, '047'),
(48, 1, '2019-03-08 17:37:24', 1, '2019-03-08 17:37:24', NULL, NULL, 0, 15, 'ageseason', '款式年代', NULL, NULL, NULL, NULL, NULL, NULL, 0, '048'),
(49, 1, '2019-03-08 17:40:43', 1, '2019-03-08 17:40:43', NULL, NULL, 0, 15, 'colortemplate', '颜色模板', NULL, NULL, NULL, NULL, NULL, NULL, 0, '049'),
(50, 1, '2019-03-08 17:41:02', 1, '2019-03-08 17:41:02', NULL, NULL, 0, 15, 'sizetop', '商品尺码', NULL, NULL, NULL, NULL, NULL, NULL, 0, '050'),
(51, 1, '2019-03-08 17:41:20', 1, '2019-03-08 17:41:20', NULL, NULL, 0, 15, 'material', '材质管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '051'),
(52, 1, '2019-03-08 17:41:39', 1, '2019-03-08 17:41:39', NULL, NULL, 0, 15, 'ulnarinch', '商品尺寸', NULL, NULL, NULL, NULL, NULL, NULL, 0, '052'),
(53, 1, '2019-03-08 17:41:58', 1, '2019-03-08 17:41:58', NULL, NULL, 0, 15, 'aliases', '商品别名', NULL, NULL, NULL, NULL, NULL, NULL, 0, '053'),
(54, 1, '2019-03-08 17:42:16', 1, '2019-03-08 17:42:16', NULL, NULL, 0, 15, 'productinnards', '内部结构', NULL, NULL, NULL, NULL, NULL, NULL, 0, '054'),
(55, 1, '2019-03-08 17:42:35', 1, '2019-03-08 17:42:35', NULL, NULL, 0, 15, 'productparts', '附带配件', NULL, NULL, NULL, NULL, NULL, NULL, 0, '055'),
(56, 1, '2019-03-08 17:42:52', 1, '2019-03-08 17:42:52', NULL, NULL, 0, 15, 'occasionsstyle', '场合风格', NULL, NULL, NULL, NULL, NULL, NULL, 0, '056'),
(57, 1, '2019-03-08 17:49:10', 1, '2019-03-08 17:49:10', NULL, NULL, 0, 15, 'closedway', '闭合方式', NULL, NULL, NULL, NULL, NULL, NULL, 0, '057'),
(58, 1, '2019-03-08 17:50:10', 1, '2019-03-08 17:50:10', NULL, NULL, 0, 15, 'executioncategory', '执行标准', NULL, NULL, NULL, NULL, NULL, NULL, 0, '058'),
(59, 1, '2019-03-08 17:50:26', 1, '2019-03-08 17:50:26', NULL, NULL, 0, 15, 'securitycategory', '安全类别', NULL, NULL, NULL, NULL, NULL, NULL, 0, '059'),
(60, 1, '2019-03-08 17:50:56', 1, '2019-03-08 17:50:56', NULL, NULL, 0, 15, 'washinginstructions', '洗涤说明', NULL, NULL, NULL, NULL, NULL, NULL, 0, '060'),
(61, 1, '2019-03-08 17:51:32', 1, '2019-03-08 17:51:32', NULL, NULL, 0, 15, 'winterproofing', '防寒指数', NULL, NULL, NULL, NULL, NULL, NULL, 0, '061'),
(62, 1, '2019-03-08 17:55:31', 1, '2019-03-08 17:55:31', NULL, NULL, 0, 16, 'productprice', '商品价格管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '062'),
(63, 1, '2019-03-08 17:55:52', 1, '2019-03-08 17:55:52', NULL, NULL, 0, 16, 'costformula', '成本计算管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '063'),
(64, 1, '2019-03-08 17:56:56', 1, '2019-03-08 17:56:56', NULL, NULL, 0, 17, 'warehouse', '仓库管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '064'),
(65, 1, '2019-03-08 17:57:20', 1, '2019-03-08 17:57:20', NULL, NULL, 0, 17, 'salesport', '销售端口管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '065'),
(66, 1, '2019-03-08 17:57:40', 1, '2019-03-08 17:57:40', NULL, NULL, 0, 17, 'country', '国际及地区信息维护', NULL, NULL, NULL, NULL, NULL, NULL, 0, '066'),
(67, 1, '2019-03-08 17:58:11', 1, '2019-03-08 17:58:11', NULL, NULL, 0, 17, 'feenames', '费用名称', NULL, NULL, NULL, NULL, NULL, NULL, 0, '067'),
(68, 1, '2019-03-08 17:58:31', 1, '2019-03-08 17:58:31', NULL, NULL, 0, 17, 'shippingtype', '运输方式', NULL, NULL, NULL, NULL, NULL, NULL, 0, '068'),
(69, 1, '2019-03-08 17:58:53', 1, '2019-03-08 17:58:53', NULL, NULL, 0, 17, 'salesmethods', '销售性质', NULL, NULL, NULL, NULL, NULL, NULL, 0, '069'),
(70, 1, '2019-03-08 17:59:10', 1, '2019-03-08 17:59:10', NULL, NULL, 0, 17, 'businesstype', '业务类型', NULL, NULL, NULL, NULL, NULL, NULL, 0, '070'),
(71, 1, '2019-03-08 17:59:26', 1, '2019-03-08 17:59:26', NULL, NULL, 0, 17, 'reportstyle', '快递单样式', NULL, NULL, NULL, NULL, NULL, NULL, 0, '071'),
(72, 1, '2019-03-08 17:59:51', 1, '2019-03-08 17:59:51', NULL, NULL, 0, 17, 'imagetool', '图片工具', NULL, NULL, NULL, NULL, NULL, NULL, 0, '072'),
(73, 1, '2019-03-08 18:07:56', 1, '2019-03-08 18:07:56', NULL, NULL, 0, 24, 'order', '订单管理', NULL, NULL, NULL, NULL, NULL, NULL, 0, '073'),
(74, 1, '2019-03-08 18:11:11', 1, '2019-03-08 18:11:11', NULL, NULL, 0, 24, 'order/search', '订单状态查询', NULL, NULL, NULL, NULL, NULL, NULL, 0, '074'),
(75, 1, '2019-03-08 18:11:32', 1, '2019-03-08 18:11:32', NULL, NULL, 0, 24, 'order/export', '订单导出', NULL, NULL, NULL, NULL, NULL, NULL, 0, '075'),
(76, 1, '2019-03-08 18:30:33', 1, '2019-03-08 18:30:33', NULL, NULL, 0, 26, 'warehousing', '到货入库', NULL, NULL, NULL, NULL, NULL, NULL, 0, '076'),
(77, 1, '2019-03-08 18:32:22', 1, '2019-03-08 18:32:22', NULL, NULL, 0, 26, 'warehousing/list', '入库单查询', NULL, NULL, NULL, NULL, NULL, NULL, 0, '077'),
(78, 1, '2019-03-08 18:37:56', 1, '2019-03-08 18:37:56', NULL, NULL, 0, 27, 'requisition/apply', '调拨单查询/申请', NULL, NULL, NULL, NULL, NULL, NULL, 0, '078'),
(79, 1, '2019-03-08 18:46:27', 1, '2019-03-08 18:46:27', NULL, NULL, 0, 27, 'requisition/turnout', '调拨出库确认', NULL, NULL, NULL, NULL, NULL, NULL, 0, '079'),
(80, 1, '2019-03-08 18:46:34', 1, '2019-03-08 18:46:34', NULL, NULL, 0, 27, 'requisition/turnin', '调拨入库确认', NULL, NULL, NULL, NULL, NULL, NULL, 0, '080'),
(81, 1, '2019-03-08 18:55:25', 1, '2019-03-08 18:55:25', NULL, NULL, 0, 28, 'check', '盘点单列表', NULL, NULL, NULL, NULL, NULL, NULL, 0, '081'),
(82, 1, '2019-03-08 18:56:24', 1, '2019-03-08 18:56:24', NULL, NULL, 0, 28, 'check/detail', '库存变动查询', NULL, NULL, NULL, NULL, NULL, NULL, 0, '082'),
(83, 1, '2019-03-08 19:01:59', 1, '2019-03-08 19:01:59', NULL, NULL, 0, 34, 'sf/sheet', '销售对账页面', NULL, NULL, NULL, NULL, NULL, NULL, 0, '083'),
(84, 1, '2019-03-08 19:02:43', 1, '2019-03-08 19:02:43', NULL, NULL, 0, 34, 'sf/search', '对账查询页面', NULL, NULL, NULL, NULL, NULL, NULL, 0, '084');
