...
CREATE TABLE `dd_confirmorder` (
                                 ...
                                 `flightdate` datetime DEFAULT NULL COMMENT '起飞时间',
                                 ...
                                 `dispatchport` varchar(50) DEFAULT NULL COMMENT '发货港',
                                 `deliveryport` varchar(50) DEFAULT NULL COMMENT '到货港',
...
CREATE TABLE `dd_order` (
                          ...
                          `agentid` int(10) unsigned DEFAULT NULL COMMENT '代理单位ID',
                          `purchasedept` int(10) unsigned DEFAULT NULL COMMENT '货主',
                          ...
                          `tsl` decimal(16,9) DEFAULT NULL COMMENT '退税率',
...
CREATE TABLE `dd_orderdetails` (
                                 ...
                                 `sys_delete_date` datetime DEFAULT NULL,
                                 `sys_delete_flag` tinyint(1) NULL DEFAULT '0' COMMENT '0-未删除 1-已删除',
                                 `orderid` int(10) unsigned DEFAULT NULL COMMENT '外键ID(订单ID)',
                                 `sizecontentid` int(10) unsigned DEFAULT NULL COMMENT '尺码ID',
                                 `number` int(11) DEFAULT NULL COMMENT '件数（数量）',
                                 `productid` int(10) unsigned DEFAULT NULL COMMENT '商品ID',
                                 `price` decimal(16,9) DEFAULT NULL COMMENT '单价',
                                 ...
                                 `zkl` decimal(16,9) DEFAULT NULL COMMENT '折扣率',
                                 `tsbl` decimal(16,9) DEFAULT NULL COMMENT '退税比例',
                                 `cjj` decimal(16,9) DEFAULT NULL COMMENT '成交价格',
                                 `yj` decimal(16,9) DEFAULT NULL COMMENT '佣金',
                                 `sortnum` int(11) DEFAULT NULL COMMENT '序号',
                                 `zje` decimal(16,9) DEFAULT NULL COMMENT '总金额',
                                 `add_flag` varchar(1) DEFAULT NULL COMMENT '追加标记',
                                 `thattimestock` int(11) DEFAULT NULL COMMENT '即时库存数',
                                 `companyid` int(11) DEFAULT NULL COMMENT '公司ID',
                                 PRIMARY KEY (`id`),
                                 KEY `companyid` (`companyid`)
